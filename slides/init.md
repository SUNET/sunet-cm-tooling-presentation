...
When running `./bumptag` the clients local trust is in used (`gpg --list-keys`) so you might need to import (and in some cases trust) keys locally in order to bump.
